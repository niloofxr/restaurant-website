...
const MENU = [
  { id:'nebula', name:'Nebula oysters', description:'Mignonette, finger lime, black garlic', price:18, category:'First contact', tag:'Raw' },
  { id:'solar', name:'Solar flare', description:'Charred carrot, vadouvan, smoked yogurt', price:14, category:'First contact', tag:'Vegetarian' },
  { id:'moon', name:'Moonstone crudo', description:'Ora king salmon, yuzu kosho, sesame', price:22, category:'First contact', tag:'Raw' },
